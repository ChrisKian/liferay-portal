...
if (GetterUtil.getBoolean((String)request.getAttribute("liferay-ui:input-date:disableNamespace")) || !GetterUtil.getBoolean((String)request.getAttribute("liferay-ui:input-date:useNamespace"), true)) {
