...
export class IdentityProviderConnectionsPage {
	...
	constructor(page: Page) {
		...
		this.unknownUsersAreStrangersToggle =
			page.getByText('Unknown Users Are Strangers');
	...
	private async populateAndSaveIdentityProviderConnectionDetails(
		...
		if (unknownUsersAreStrangers != undefined) {
			await this.unknownUsersAreStrangersToggle.setChecked(unknownUsersAreStrangers);
		}
