...
public class PortalInstancesTest {
	...
	public void testi18nLanguageIdNotSet() throws Exception {
		...
		_testGetI18NLanguageId(hostname, null, null, null);

		// No session

		_testGetI18NLanguageId(
			hostname, GroupConstants.CONTROL_PANEL_FRIENDLY_URL, null, null);

		// Invalid path

		_testGetI18NLanguageId(hostname, null, _company.getLocale(), null);

		// Unavailable languageId

		_testGetI18NLanguageId(
			hostname, GroupConstants.CONTROL_PANEL_FRIENDLY_URL,
			LanguageUtil.getLocale(_UNAVAILABLE_LANGUAGE_ID), null);
	}
	...
	public void testi18nLanguageIdSet() throws Exception {
		...
		_testGetI18NLanguageId(hostname, null, null, _SITE_DEFAULT_LANGUAGE_ID);

		// Session, path, valid locale
	...
	private void _testGetI18NLanguageId(
		String hostname, String pathInfo, Locale locale,
