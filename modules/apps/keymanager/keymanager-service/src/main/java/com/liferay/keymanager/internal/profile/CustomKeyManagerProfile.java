...
/**
 * Manual-configuration profile. Each of the six provider ids is sourced
 * directly from {@link KeyManagerCustomProfileConfiguration}; no automatic
 * provisioning happens in {@link #bootstrap()}.
 *
