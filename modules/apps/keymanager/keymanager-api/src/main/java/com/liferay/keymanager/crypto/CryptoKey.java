...
/**
 * Immutable metadata for a single key registered with a
 * {@link com.liferay.keymanager.spi.crypto.CryptoVaultProvider}.
 *
 * <p>
 * Returned by
 * {@link CryptoManager#getKeyMetadata(long, KeyReference)} so callers can
 * audit, display, or branch on the key's attributes without unwrapping the
 * key material itself.
 * </p>
 *
