...
public class SamlPeerBindingPersistenceImpl
	...
	private FinderPath _finderPathWithPaginationFindByC_U_D;
	private FinderPath _finderPathWithoutPaginationFindByC_U_D;
	private FinderPath _finderPathCountByC_U_D;

	/**
	 * Returns all the saml peer bindings where companyId = &#63; and userId = &#63; and deleted = &#63;.
	 *
	 ...
	 */
	@Override
	public List<SamlPeerBinding> findByC_U_D(
		long companyId, long userId, boolean deleted) {

		return findByC_U_D(
			companyId, userId, deleted, QueryUtil.ALL_POS, QueryUtil.ALL_POS,
			null);
	}

	/**
	 * Returns a range of all the saml peer bindings where companyId = &#63; and userId = &#63; and deleted = &#63;.
	 *
	 * <p>
	...
	@Override
	public List<SamlPeerBinding> findByC_U_D(
		long companyId, long userId, boolean deleted, int start, int end) {

		return findByC_U_D(companyId, userId, deleted, start, end, null);
	}

	/**
	 * Returns an ordered range of all the saml peer bindings where companyId = &#63; and userId = &#63; and deleted = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to <code>QueryUtil#ALL_POS</code> will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent, then the query will include the default ORDER BY logic from <code>SamlPeerBindingModelImpl</code>.
	 * </p>
	...
	public List<SamlPeerBinding> findByC_U_D(
		...
		return findByC_U_D(
			companyId, userId, deleted, start, end, orderByComparator, true);
	}
	...
	public List<SamlPeerBinding> findByC_U_D(
		...
		if ((start == QueryUtil.ALL_POS) && (end == QueryUtil.ALL_POS) &&
			...
			if (useFinderCache) {
				finderPath = _finderPathWithoutPaginationFindByC_U_D;
				finderArgs = new Object[] {companyId, userId, deleted};
			}
		}
		else if (useFinderCache) {
			finderPath = _finderPathWithPaginationFindByC_U_D;
			finderArgs = new Object[] {
				companyId, userId, deleted, start, end, orderByComparator
			};
		}
		...
		if (list == null) {
			...
			sb.append(_FINDER_COLUMN_C_U_D_COMPANYID_2);

			sb.append(_FINDER_COLUMN_C_U_D_USERID_2);

			sb.append(_FINDER_COLUMN_C_U_D_DELETED_2);
	...
	/**
	 * Returns the first saml peer binding in the ordered set where companyId = &#63; and userId = &#63; and deleted = &#63;.
	 *
	 * @param companyId the company ID
	 * @param userId the user ID
	 * @param deleted the deleted
	 ...
	 */
	@Override
	public SamlPeerBinding findByC_U_D_First(
			long companyId, long userId, boolean deleted,
			OrderByComparator<SamlPeerBinding> orderByComparator)
		throws NoSuchPeerBindingException {

		SamlPeerBinding samlPeerBinding = fetchByC_U_D_First(
			companyId, userId, deleted, orderByComparator);
	 ...
	 */
	@Override
	public SamlPeerBinding fetchByC_U_D_First(
		long companyId, long userId, boolean deleted,
		OrderByComparator<SamlPeerBinding> orderByComparator) {

		List<SamlPeerBinding> list = findByC_U_D(
			companyId, userId, deleted, 0, 1, orderByComparator);
	...
	/**
	 * Returns the last saml peer binding in the ordered set where companyId = &#63; and userId = &#63; and deleted = &#63;.
	 *
	 * @param companyId the company ID
	 * @param userId the user ID
	 * @param deleted the deleted
	 ...
	 */
	@Override
	public SamlPeerBinding findByC_U_D_Last(
			long companyId, long userId, boolean deleted,
			OrderByComparator<SamlPeerBinding> orderByComparator)
		throws NoSuchPeerBindingException {

		SamlPeerBinding samlPeerBinding = fetchByC_U_D_Last(
			companyId, userId, deleted, orderByComparator);
	 ...
	 */
	@Override
	public SamlPeerBinding fetchByC_U_D_Last(
		long companyId, long userId, boolean deleted,
		OrderByComparator<SamlPeerBinding> orderByComparator) {

		int count = countByC_U_D(companyId, userId, deleted);
		...
		List<SamlPeerBinding> list = findByC_U_D(
			companyId, userId, deleted, count - 1, count, orderByComparator);
	...
	/**
	 * Returns the saml peer bindings before and after the current saml peer binding in the ordered set where companyId = &#63; and userId = &#63; and deleted = &#63;.
	 *
	 ...
	 */
	@Override
	public SamlPeerBinding[] findByC_U_D_PrevAndNext(
	...
	protected SamlPeerBinding getByC_U_D_PrevAndNext(
	...
	/**
	 * Removes all the saml peer bindings where companyId = &#63; and userId = &#63; and deleted = &#63; from the database.
	 *
	 * @param companyId the company ID
	 * @param userId the user ID
	 * @param deleted the deleted
	 */
	@Override
	public void removeByC_U_D(long companyId, long userId, boolean deleted) {
		for (SamlPeerBinding samlPeerBinding :
				findByC_U_D(
					companyId, userId, deleted, QueryUtil.ALL_POS,
	...
	/**
	 * Returns the number of saml peer bindings where companyId = &#63; and userId = &#63; and deleted = &#63;.
	 *
	 * @param companyId the company ID
	 * @param userId the user ID
	 * @param deleted the deleted
	 ...
	 */
	@Override
	public int countByC_U_D(long companyId, long userId, boolean deleted) {
		FinderPath finderPath = _finderPathCountByC_U_D;

		Object[] finderArgs = new Object[] {companyId, userId, deleted};
	...
	private static final String _FINDER_COLUMN_C_U_D_COMPANYID_2 =
		"samlPeerBinding.companyId = ? AND ";

	private static final String _FINDER_COLUMN_C_U_D_USERID_2 =
		"samlPeerBinding.userId = ? AND ";

	private static final String _FINDER_COLUMN_C_U_D_DELETED_2 =
	...
	public void activate() {
		...
		_finderPathWithPaginationFindByC_U_D = new FinderPath(
			FINDER_CLASS_NAME_LIST_WITH_PAGINATION, "findByC_U_D",
			new String[] {
				Long.class.getName(), Long.class.getName(),
				Boolean.class.getName(), Integer.class.getName(),
				Integer.class.getName(), OrderByComparator.class.getName()
			},
			new String[] {"companyId", "userId", "deleted"}, true);

		_finderPathWithoutPaginationFindByC_U_D = new FinderPath(
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "findByC_U_D",
			new String[] {
				Long.class.getName(), Long.class.getName(),
		...
		_finderPathCountByC_U_D = new FinderPath(
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "countByC_U_D",
			new String[] {
				Long.class.getName(), Long.class.getName(),
				Boolean.class.getName()
			},
			new String[] {"companyId", "userId", "deleted"}, false);
