...
public class SamlPeerBindingUtil {
	 ...
	 */
	public static List<SamlPeerBinding> findByC_U_D(
		long companyId, long userId, boolean deleted) {

		return getPersistence().findByC_U_D(companyId, userId, deleted);
	}
	...
	public static List<SamlPeerBinding> findByC_U_D(
		...
		return getPersistence().findByC_U_D(
			companyId, userId, deleted, start, end);
	}
	 ...
	 */
	public static SamlPeerBinding findByC_U_D_First(
			long companyId, long userId, boolean deleted,
			OrderByComparator<SamlPeerBinding> orderByComparator)
		throws com.liferay.saml.persistence.exception.
			NoSuchPeerBindingException {

		return getPersistence().findByC_U_D_First(
	 ...
	 */
	public static SamlPeerBinding fetchByC_U_D_First(
		long companyId, long userId, boolean deleted,
		OrderByComparator<SamlPeerBinding> orderByComparator) {

		return getPersistence().fetchByC_U_D_First(
			companyId, userId, deleted, orderByComparator);
	}
	 ...
	 * @throws NoSuchPeerBindingException if a matching saml peer binding could not be found
	 */
	public static SamlPeerBinding findByC_U_D_Last(
			long companyId, long userId, boolean deleted,
			OrderByComparator<SamlPeerBinding> orderByComparator)
		throws com.liferay.saml.persistence.exception.
			NoSuchPeerBindingException {

		return getPersistence().findByC_U_D_Last(
			companyId, userId, deleted, orderByComparator);
	}
	 ...
	 */
	public static SamlPeerBinding fetchByC_U_D_Last(
		long companyId, long userId, boolean deleted,
		OrderByComparator<SamlPeerBinding> orderByComparator) {

		return getPersistence().fetchByC_U_D_Last(
			companyId, userId, deleted, orderByComparator);
	}
	 ...
	 */
	public static SamlPeerBinding[] findByC_U_D_PrevAndNext(
		...
		return getPersistence().findByC_U_D_PrevAndNext(
			samlPeerBindingId, companyId, userId, deleted, orderByComparator);
	}
	 ...
	 * @param deleted the deleted
	 */
	public static void removeByC_U_D(
		long companyId, long userId, boolean deleted) {

		getPersistence().removeByC_U_D(companyId, userId, deleted);
	}
	 ...
	 */
	public static int countByC_U_D(
		long companyId, long userId, boolean deleted) {

		return getPersistence().countByC_U_D(companyId, userId, deleted);
	}
